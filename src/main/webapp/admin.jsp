...
<body>
    ...
    <div class="container">
        <!-- Dashboard Summary - Shifted up and made horizontal -->
        <%
        ...
        <h2 style="color: #FBC02D; font-weight: 900; margin-bottom: 25px; display: flex; align-items: center; gap: 10px;">
        ...
        %>
            <div class="student-card">
                ...
                <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 15px; font-size: 14px; background: rgba(0,0,0,0.2); padding: 20px; border-radius: 15px; margin-bottom: 20px;">
                    <div><i class="fas fa-phone-alt" style="color: #FBC02D; width: 20px;"></i> <strong>Phone:</strong> <%= student.getPhone() %></div>
