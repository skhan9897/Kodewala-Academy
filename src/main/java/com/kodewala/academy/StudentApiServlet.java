...
public class StudentApiServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            data.put("studentId", "PENDING"); // ID will be generated by Admin
            data.put("batchNumber", "PENDING"); // Batch will be generated by Admin
            ...
            data.put("paymentStatus", "Awaiting Verification");
